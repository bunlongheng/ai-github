...
export const PR_CATALOG: Omit<PR, "liveStatus" | "liveTitle" | "mergedAt" | "closedAt" | "url">[] = [
  {
    ...
    title: "fix: enforce Xero webhook signature verification before emitting events",
  ...
  },
  {
    number: 3767,
    repo: "ipspace/netlab",
    title: "fix: add timeout and scheme validation when fetching remote topologies",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    ...
    title: "fix: escape backslashes in SQLAlchemy DDL comment rendering",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    ...
    title: "fix: validate scheme of bundled URL preview links",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
  ...
  },
  {
    ...
    title: "fix: force SVG attachments to download to prevent stored XSS",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    number: 655,
    repo: "arabcoders/ytptube",
    title: "fix: prevent path traversal in file browser rename action",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    ...
    title: "fix: command injection via Nx Cloud CIPE branch name",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    number: 3271,
    repo: "chakra-ui/zag",
    title: "fix: DOM XSS in auto-resize ghost element via innerHTML",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
  {
    number: 614,
    repo: "fleetbase/fleetbase",
    title: "fix: script injection via PR branch name in cloud workflow",
    issue: "security-audit",
    submittedAt: "2026-08-11",
  },
];
